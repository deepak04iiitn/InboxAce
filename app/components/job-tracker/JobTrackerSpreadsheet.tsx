...
export default function JobTrackerSpreadsheet() {
    ...
    <div className="min-h-screen bg-black p-6">
      <div className="max-w-[95vw] mx-auto mt-20">
        <div className="mb-6">
          ...
          <p className="text-gray-400">Manage your cold emails in a spreadsheet-like interface</p>
        </div>
        ...
        <div className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-4 mb-4">
          <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="flex-1 min-w-[300px] relative">
              ...
              <input type="text" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} placeholder="Search by name, email, company, or position..." className="w-full pl-10 pr-4 py-2 bg-gray-900/50 border border-gray-700/50 rounded-lg text-white focus:ring-2 focus:ring-purple-500" />
            </div>
